...
| **接口极简** | P0 MVP 仅 **8+1 方法**（8 纯虚 + 1 可降级）；P1 B2 扩展 **+2 虚方法**（默认空实现，客户可选） |
...
| 图类型 | P0 (MVP) | P1 (B1) | P1 (B2) | P2 (V2.0) |
|--------|----------|---------|---------|-----------|
| Line Plot (折线图) | ✅ | — | — | — |
| Scatter Plot (散点图) | ✅ | — | — | — |
| Multi Y-Axis (多Y轴) | ✅ | — | — | — |
...
> **B1**: 零接口变更，复用 P0 8+1 方法。**B2**: 扩展 2 个新虚方法 (`fillPolygon` + `drawImage`)，均为带默认空实现的非纯虚方法，客户可选择性实现。
